...
if (isset($_POST["Location"])) {
  ...
  $conn = getConnection();
  $conn->query("UPDATE Incidents SET Location='".$_POST["Location"]."' WHERE IncidentID='".$_POST["incident"]."'");
  $conn->query("UPDATE Incidents SET Borough='".$_POST["Borough"]."' WHERE IncidentID='".$_POST["incident"]."'");
    ...
    <div class="modal-dialog modal-full">
        <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <form method="post" action="cad_edit_location.php?incident=<?php echo($_GET["incident"]);  ?>">

              <input class="form-control" name="Location" onclick="this.select();" placeholder="Location" value="<?php echo(getIncidentInfo("Location", $_GET["incident"])); ?>"><br>
