...
if (isset($_POST["Type"])) {
  ...
  $conn = getConnection();
  $conn->query("UPDATE Incidents SET Type='".$_POST["Type"]."' WHERE IncidentID='".$_POST["incident"]."'");
    ...
    <div class="modal-dialog modal-full">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><b>Edit Incident Type</b></h4>
            </div>
            <div class="modal-body">

              <form method="post" action="cad_edit_type.php?incident=<?php echo($_GET["incident"]);  ?>">

              <input class="form-control" name="Type" onclick="this.select();" placeholder="Incident Type" value="<?php echo(getIncidentInfo("Type", $_GET["incident"])); ?>">
