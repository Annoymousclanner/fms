    ...
    <div class="portlet light">
      ...
      <div class="portlet-body">
        ...
        <center>
          ...
          <a href="javascript:setState('Panic')" class="icon-btn">
    ...
    <div class="portlet light">
      ...
      <div class="portlet-body">
        ...
        if ($incident == 0 || $incident == "0") {
          ...
          if (getIncidentInfo("Grade") == "Grade 1") {

            $label = '<span class="label bg-red">Grade 1</span>';

          } else {

            $label = '<span class="label bg-yellow-crusta">'.getIncidentInfo("Grade").'</span>';
          ...
          echo '
          <b>INC #'.$incident.' | '.getIncidentInfo("Type").' | '.$label.'<br></b>
          <b>Location: </b> '.getIncidentInfo("Location").'<br>
          <b>Postcode: </b> '.getIncidentInfo("Borough").'<br>
          <b>Channel: </b> '.getIncidentInfo("Channel").'<br>
          <b>Details: </b> '.getIncidentInfo("Details").'<br><br>
          <b>Deployed Assets</b>
          <br><br>
          <div class="col-md-2 name">
            <b>UNIT</b>
