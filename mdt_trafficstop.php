...
if (isset($_POST["colour"])) {
  ...
  $inc = createIncident("Traffic Stop - " . $reason, $street, $borough, getCurrentInfo("Callsign") . " has stopped a " . $colour . " " . $vehicle . ' for ' . $reason, getNextChannel(), "S - SCHEDULED");
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <form action="mdt_trafficstop.php" method="post">
                ...
                <input name="borough" placeholder="Postcode" class="form-control">
