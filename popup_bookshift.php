...
if (isset($_POST["day"])) {
  ...
  if ($type == "Operational") {
    ...
    $conn = getConnection();
    $conn->query("INSERT INTO Duties (Day, UserID, Callsign, Role, Vehicle, Division) VALUES
    ('".$day."','".$_SESSION["UserID"]."','UNASSIGNED','UNASSIGNED','UNASSIGNED', '".getDivision()."')");
    ...
    <div class="modal-dialog modal-full">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Book Duty</h4>
            </div>
            <div class="modal-body">
              <form action="popup_bookshift.php" method="post">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn green">Book Duty</button></form>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
