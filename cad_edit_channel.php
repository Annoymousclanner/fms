...
if (isset($_POST["Channel"])) {
  ...
  $conn = getConnection();
  $conn->query("UPDATE Incidents SET Channel='".$_POST["Channel"]."' WHERE IncidentID='".$_POST["incident"]."'");
    ...
    <div class="modal-dialog modal-full">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><b>Edit Incident Channl</b></h4>
            </div>
            <div class="modal-body">

              <form method="post" action="cad_edit_channel.php?incident=<?php echo($_GET["incident"]);  ?>">
