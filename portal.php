<div class="page-head">
  ...
  $note;
  $note = getUserDetail($_SESSION["UserID"], "Note");

  if (isset($note) && $note != "" && $note != null) {
...
<div class="row">
  <div class="col-md-8 col-sm-8">
    ...
    <div class="portlet light">
      <div class="portlet-title">
        <div class="caption">
          <span class="caption-subject bold uppercase">Members Area</span>
          <span class="caption-helper">courses & applications</span>
        </div>
      </div>
      <div class="portlet-body">
        <?php

        $res = getConnection()->query("SELECT * FROM CourseAccess WHERE User='".$_SESSION["UserID"]."'");

        if ($res->num_rows > 0) {

          while ($r=$res->fetch_assoc()) {

            echo('<b>'.getMembersDetail($r["Course"], "Courses", "Name").': </b> <a target="_blank" href="'.getMembersDetail($r["Course"], "Courses", "Link").'">Click here</a> to view the '.getMembersDetail($r["Course"], "Courses", "Name").' course.<br>');
    ...
    <div class="portlet light">
      <div class="portlet-title">
        <div class="caption">
          ...
          <span class="caption-helper">where next?</span>
        </div>
      </div>
      <div class="portlet-body">
        ...
        if (getUserDetail($_SESSION["UserID"], "HR") == 1) {

          echo '
          <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
              <a class="dashboard-stat dashboard-stat-v2 grey" href="hr">
                <div class="visual" style="padding-top: 0px; margin-bottom: 15px;">
                ...
                <div class="details">
                  ...
                  <div class="desc"><i></i>Human Resources</div>
                </div>
              </a>
            </div>
          </div>
