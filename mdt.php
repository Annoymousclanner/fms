...
document.getElementById("informed").volume = 0.3;
document.getElementById("panic").volume = 0.1;
...
<body class="page-container-bg-solid page-header-fixed page-sidebar-closed-hide-logo">
  <audio id="informed" src="PTP.wav" autoplay loop>
        Your browser does not support the <code>audio</code> element.
    </audio>
    <audio id="panic" src="panic.wav" autoplay loop>
        Your browser does not support the <code>audio</code> element.
    </audio>
    <script>document.getElementById("informed").muted = true;</script>
    <script>document.getElementById("panic").muted = true;
	document.getElementById("informed").volume = 0.2;
	document.getElementById("panic").volume = 0.1;
	</script>
              ...
              <div class="page-sidebar navbar-collapse collapse">
                  ...
                  <ul class="page-sidebar-menu   " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                      ...
                      <li class="nav-item  ">
                          ...
                          <a href="mdt_duties.php" class="nav-link nav-toggle">
