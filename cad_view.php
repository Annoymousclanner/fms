...
<div class="row">
  <div class="col-md-3 col-lg-3 col-sm-3">
    ...
    echo(getDivision("TP", "Territorial Policing"));
    echo("<br>");
    echo(getDivision("SC&O19", "Specialist Crime & Operations 19"));
    echo("<br>");
    echo(getDivision("RTPC", "Roads Transport Policing Command"));
    echo("<br>");
    echo(getDivision("RMU", "Resource Management Unit"));
    echo("<br>");
    echo(getDivision("", ""));
  ...
  <div class="col-md-9 col-lg-9 col-sm-9">
    ...
    if ($res->num_rows > 0) {
      ...
      while ($row = $res->fetch_assoc()) {
        ...
        if ($row["Grade"] == "Grade 2" || $row["Grade"] == "Grade 3" || $row["Grade"] == "Grade 4" || $row["Grade"] == "Unset") {
        ...
        echo '<div class="portlet box dark">
          <div class="portlet-title">
            <div class="caption">
              <span class="caption-subject"><small>INC #'.$row["IncidentID"].'S | '.$row["Type"].' | '.$row["Location"].' ('.$row["Borough"].') | '.$label.'</small><br>
